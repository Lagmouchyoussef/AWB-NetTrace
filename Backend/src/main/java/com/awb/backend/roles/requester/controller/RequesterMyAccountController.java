...
// under the Requester URL namespace (see DcAdminMyAccountController for the same pattern). No
...
@RestController
@RequestMapping("/api/roles/requester/my-account")
public class RequesterMyAccountController {

  private final MyAccountService myAccountService;

  public RequesterMyAccountController(MyAccountService myAccountService) {
