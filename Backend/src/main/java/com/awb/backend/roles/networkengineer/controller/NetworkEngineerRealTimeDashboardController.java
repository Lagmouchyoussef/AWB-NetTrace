...
// Delegates to the same RealTimeDashboardService Super Admin uses. No delete endpoint -
// decommission via status (ARCHIVED is the closest equivalent).
@RestController
@RequestMapping("/api/roles/network-engineer/real-time-dashboards")
public class NetworkEngineerRealTimeDashboardController {

  private final RealTimeDashboardService realTimeDashboardService;

  public NetworkEngineerRealTimeDashboardController(
