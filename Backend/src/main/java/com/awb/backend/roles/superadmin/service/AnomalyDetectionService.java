...
public class AnomalyDetectionService {
  ...
  @Transactional
  public AnomalyDetectionResponse create(AnomalyDetectionRequest request) {
    ...
    return toResponse(anomalyDetectionRepository.save(anomaly));
  }

  @Transactional
  public AnomalyDetectionResponse update(Long id, AnomalyDetectionRequest request) {
