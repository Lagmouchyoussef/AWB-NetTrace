...
// Delegates to the same ConnectorService Super Admin uses. No delete endpoint - decommission via
// status (Connector already has a DECOMMISSIONED value).
@RestController
@RequestMapping("/api/roles/network-engineer/connectors")
public class NetworkEngineerConnectorController {

  private final ConnectorService connectorService;

  public NetworkEngineerConnectorController(ConnectorService connectorService) {
