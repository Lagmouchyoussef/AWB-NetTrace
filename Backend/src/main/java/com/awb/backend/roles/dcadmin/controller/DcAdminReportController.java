...
// Delegates entirely to the same ReportService Super Admin uses, so audit logging and live
// notification broadcasting (AuditLogWriter) is shared automatically.
@RestController
@RequestMapping("/api/roles/dc-admin/reports")
public class DcAdminReportController {

  private final ReportService reportService;

  public DcAdminReportController(ReportService reportService) {
