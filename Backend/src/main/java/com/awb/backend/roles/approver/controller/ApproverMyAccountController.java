...
// under the Approver URL namespace (see DcAdminMyAccountController for the same pattern). No
...
@RestController
@RequestMapping("/api/roles/approver/my-account")
public class ApproverMyAccountController {

  private final MyAccountService myAccountService;

  public ApproverMyAccountController(MyAccountService myAccountService) {
