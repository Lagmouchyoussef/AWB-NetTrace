...
public class SystemSettingController {
  ...
  public ResponseEntity<SystemSettingResponse> create(
      @Valid @RequestBody SystemSettingRequest request, Authentication authentication) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(systemSettingService.create(request, authentication.getName()));
  }
  ...
  public SystemSettingResponse update(
    ...
    return systemSettingService.update(id, request, authentication.getName());
  }

  @DeleteMapping("/{id}")
  public ResponseEntity<Void> delete(@PathVariable Long id, Authentication authentication) {
    systemSettingService.delete(id, authentication.getName());
