...
// Delegates to the same SdwanEdgeService Super Admin uses. No delete endpoint - decommission via
// status.
@RestController
@RequestMapping("/api/roles/network-engineer/sdwan-edges")
public class NetworkEngineerSdwanEdgeController {

  private final SdwanEdgeService sdwanEdgeService;

  public NetworkEngineerSdwanEdgeController(SdwanEdgeService sdwanEdgeService) {
