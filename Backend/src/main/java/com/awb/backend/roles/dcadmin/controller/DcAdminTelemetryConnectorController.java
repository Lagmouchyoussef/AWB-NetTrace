...
// Delegates entirely to the same TelemetryConnectorService Super Admin uses, so audit logging
// and live notification broadcasting (AuditLogWriter) is shared automatically.
@RestController
@RequestMapping("/api/roles/dc-admin/telemetry-connectors")
public class DcAdminTelemetryConnectorController {

  private final TelemetryConnectorService telemetryConnectorService;

  public DcAdminTelemetryConnectorController(TelemetryConnectorService telemetryConnectorService) {
