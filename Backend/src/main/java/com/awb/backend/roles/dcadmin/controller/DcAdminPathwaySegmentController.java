...
// Delegates entirely to the same PathwaySegmentService Super Admin uses, so audit logging and
// live notification broadcasting (AuditLogWriter) is shared automatically.
@RestController
@RequestMapping("/api/roles/dc-admin/pathway-segments")
public class DcAdminPathwaySegmentController {

  private final PathwaySegmentService pathwaySegmentService;

  public DcAdminPathwaySegmentController(PathwaySegmentService pathwaySegmentService) {
