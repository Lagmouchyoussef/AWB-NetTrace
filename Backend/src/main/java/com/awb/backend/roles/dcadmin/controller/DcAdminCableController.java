...
// Delegates entirely to the same CableService Super Admin uses, so audit logging and live
// notification broadcasting (AuditLogWriter) is shared automatically.
@RestController
@RequestMapping("/api/roles/dc-admin/cables")
public class DcAdminCableController {

  private final CableService cableService;

  public DcAdminCableController(CableService cableService) {
