...
// under the Technician URL namespace (see DcAdminMyAccountController for the same pattern). No
// IP-restriction / allowed-ips endpoints here: that's an admin/security concern, not relevant to
// a field technician's own account.
@RestController
@RequestMapping("/api/roles/technician/my-account")
public class TechnicianMyAccountController {

  private final MyAccountService myAccountService;

  public TechnicianMyAccountController(MyAccountService myAccountService) {
