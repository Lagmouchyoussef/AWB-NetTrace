...
// Delegates entirely to the same OverlayNetworkService Super Admin uses. Read-only: overlay
// networks (VXLAN/EVPN) are viewed here, not managed.
@RestController
@RequestMapping("/api/roles/dc-admin/overlay-networks")
public class DcAdminOverlayNetworkController {

  private final OverlayNetworkService overlayNetworkService;

  public DcAdminOverlayNetworkController(OverlayNetworkService overlayNetworkService) {
