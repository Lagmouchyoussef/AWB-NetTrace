...
// Delegates to the same TechnologyCatalogService Super Admin uses. No delete endpoint -
// decommission via status.
@RestController
@RequestMapping("/api/roles/network-engineer/technology-catalog")
public class NetworkEngineerTechnologyCatalogController {

  private final TechnologyCatalogService technologyCatalogService;

  public NetworkEngineerTechnologyCatalogController(
      TechnologyCatalogService technologyCatalogService) {
