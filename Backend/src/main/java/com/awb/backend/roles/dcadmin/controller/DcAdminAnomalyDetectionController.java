...
// Delegates to the same AnomalyDetectionService Super Admin uses - see DcAdminDatacenterController.
@RestController
@RequestMapping("/api/roles/dc-admin/anomaly-detections")
public class DcAdminAnomalyDetectionController {

  private final AnomalyDetectionService anomalyDetectionService;

  public DcAdminAnomalyDetectionController(AnomalyDetectionService anomalyDetectionService) {
