...
// Delegates to the same RackService Super Admin uses - see DcAdminDatacenterController.
@RestController
@RequestMapping("/api/roles/dc-admin/racks")
public class DcAdminRackController {

  private final RackService rackService;

  public DcAdminRackController(RackService rackService) {
