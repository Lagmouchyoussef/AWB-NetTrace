...
// Delegates entirely to the same ConnectorService Super Admin uses, so audit logging and live
// notification broadcasting (AuditLogWriter) is shared automatically.
@RestController
@RequestMapping("/api/roles/dc-admin/connectors")
public class DcAdminConnectorController {

  private final ConnectorService connectorService;

  public DcAdminConnectorController(ConnectorService connectorService) {
