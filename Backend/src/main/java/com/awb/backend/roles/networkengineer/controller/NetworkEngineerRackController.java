...
// Delegates to the same RackService Super Admin uses - see NetworkEngineerDatacenterController.
// Read-only in the Network Engineer frontend.
@RestController
@RequestMapping("/api/roles/network-engineer/racks")
public class NetworkEngineerRackController {

  private final RackService rackService;

  public NetworkEngineerRackController(RackService rackService) {
