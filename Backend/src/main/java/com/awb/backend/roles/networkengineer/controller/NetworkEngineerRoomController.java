...
// Delegates to the same RoomService Super Admin uses - see NetworkEngineerDatacenterController.
// Read-only in the Network Engineer frontend.
@RestController
@RequestMapping("/api/roles/network-engineer/rooms")
public class NetworkEngineerRoomController {

  private final RoomService roomService;

  public NetworkEngineerRoomController(RoomService roomService) {
