...
// Delegates entirely to the same EquipmentTypeService Super Admin uses. The DC Admin frontend
// only exposes list/view for this module (Technical Library is read-only for this role) but the
// write endpoints are left in place rather than removed, matching every other DcAdmin controller
// - the role's write restriction is a frontend/UX concern here, not a missing capability.
@RestController
@RequestMapping("/api/roles/dc-admin/equipment-types")
public class DcAdminEquipmentTypeController {

  private final EquipmentTypeService equipmentTypeService;

  public DcAdminEquipmentTypeController(EquipmentTypeService equipmentTypeService) {
