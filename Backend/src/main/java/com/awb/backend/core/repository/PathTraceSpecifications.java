...
public final class PathTraceSpecifications {

  private PathTraceSpecifications() {}
  ...
  public static Specification<PathTrace> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<PathTrace> search(String search) {
  ...
  public static Specification<PathTrace> hasStatus(PathTraceStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
