...
public final class RackSpecifications {

  private RackSpecifications() {}
  ...
  public static Specification<Rack> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<Rack> search(String search) {
  ...
  public static Specification<Rack> hasStatus(RackStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
  ...
  public static Specification<Rack> hasRoomId(Long roomId) {
    if (roomId == null) {
      return (root, query, cb) -> cb.conjunction();
    }
