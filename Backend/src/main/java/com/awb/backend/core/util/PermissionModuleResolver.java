...
public class PermissionModuleResolver {
  ...
  private static final Map<String, PermissionModule> SEGMENT_TO_MODULE =
      Map.ofEntries(
          ...
          Map.entry("sdwan-edges", PermissionModule.SDWAN),
          Map.entry("overlay-tunnels", PermissionModule.SDWAN),
          Map.entry("carrier-circuits", PermissionModule.SDWAN),
          Map.entry("telemetry-connectors", PermissionModule.TELEMETRY),
          Map.entry("real-time-dashboards", PermissionModule.TELEMETRY),
          Map.entry("anomaly-detections", PermissionModule.TELEMETRY),
          Map.entry("equipment-types", PermissionModule.LIBRARY),
          Map.entry("technology-catalog", PermissionModule.LIBRARY),
