...
public final class ConnectorSpecifications {

  private ConnectorSpecifications() {}
  ...
  public static Specification<Connector> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<Connector> search(String search) {
  ...
  public static Specification<Connector> hasStatus(ConnectorStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
