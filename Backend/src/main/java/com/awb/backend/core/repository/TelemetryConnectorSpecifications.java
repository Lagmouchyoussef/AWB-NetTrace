...
public final class TelemetryConnectorSpecifications {

  private TelemetryConnectorSpecifications() {}
  ...
  public static Specification<TelemetryConnector> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<TelemetryConnector> search(String search) {
  ...
  public static Specification<TelemetryConnector> hasStatus(TelemetryConnectorStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
