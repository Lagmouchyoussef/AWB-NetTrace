...
public final class CableSpecifications {

  private CableSpecifications() {}
  ...
  public static Specification<Cable> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<Cable> search(String search) {
  ...
  public static Specification<Cable> hasStatus(CableStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
