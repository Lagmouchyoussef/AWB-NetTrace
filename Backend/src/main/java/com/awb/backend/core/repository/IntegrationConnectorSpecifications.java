...
public final class IntegrationConnectorSpecifications {

  private IntegrationConnectorSpecifications() {}
  ...
  public static Specification<IntegrationConnector> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<IntegrationConnector> search(String search) {
  ...
  public static Specification<IntegrationConnector> hasStatus(IntegrationConnectorStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
