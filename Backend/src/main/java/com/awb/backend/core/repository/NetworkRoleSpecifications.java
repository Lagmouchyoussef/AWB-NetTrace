...
public final class NetworkRoleSpecifications {

  private NetworkRoleSpecifications() {}
  ...
  public static Specification<NetworkRole> notDeleted() {
    return (root, query, cb) -> cb.isFalse(root.get("deleted"));
  }

  public static Specification<NetworkRole> search(String search) {
  ...
  public static Specification<NetworkRole> hasStatus(NetworkRoleStatus status) {
    if (status == null) {
      return (root, query, cb) -> cb.conjunction();
    }
