...
// No delete() - decommission via status. See NetworkEngineerRealTimeDashboardController.
@Injectable({ providedIn: 'root' })
export class NetworkEngineerRealTimeDashboardService {
  private readonly crud = createScopedCrudService<
    RealTimeDashboard,
    RealTimeDashboardRequest,
    RealTimeDashboardListParams
  >('/api/roles/network-engineer/real-time-dashboards');
