...
// No delete() - decommission via status. See NetworkEngineerConnectorController.
@Injectable({ providedIn: 'root' })
export class NetworkEngineerConnectorService {
  private readonly crud = createScopedCrudService<Connector, ConnectorRequest, ConnectorListParams>(
    '/api/roles/network-engineer/connectors',
  );
