...
// No delete() - decommission via status. See NetworkEngineerSdwanEdgeController.
@Injectable({ providedIn: 'root' })
export class NetworkEngineerSdwanEdgeService {
  private readonly crud = createScopedCrudService<SdwanEdge, SdwanEdgeRequest, SdwanEdgeListParams>(
    '/api/roles/network-engineer/sdwan-edges',
  );
