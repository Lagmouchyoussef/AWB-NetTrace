...
// Create-only, mirrors ApproverRequestFormDialogComponent/NeInterventionRequestFormDialogComponent
// exactly: this role only ever submits requests, it doesn't set operational status, assign a
// technician, or mark completion - those fields are hardcoded/left off this form entirely.
@Component({
  selector: 'app-requester-request-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class RequesterRequestFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<RequesterRequestFormDialogComponent, boolean>);
