...
import { RequesterMyAccountService } from '../../../../core/services/requester-my-account.service';
...
// RequesterMyAccountController) and minus its own logout button (already in the topbar, always
// visible in this role's desktop layout).
@Component({
  selector: 'app-requester-my-account',
  standalone: true,
  imports: [ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatIconModule, TranslatePipe],
  templateUrl: './my-account.component.html',
  styleUrl: './my-account.component.css',
})
export class RequesterMyAccountComponent implements OnInit {
  private readonly myAccountService = inject(RequesterMyAccountService);
