...
import {
  ...
  TechnologyCategory,
} from './technology-catalog-entry.model';

@Component({
  selector: 'app-technology-catalog-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class TechnologyCatalogFormDialogComponent {
  private readonly technologyCatalogService = inject(TechnologyCatalogService);
  private readonly dialogRef = inject(MatDialogRef<TechnologyCatalogFormDialogComponent, boolean>);
