...
import { CABLE_STATUSES, CABLE_TYPES, Cable, CableStatus, CableType } from './cable.model';

@Component({
  selector: 'app-cable-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class CableFormDialogComponent implements OnInit {
  private readonly cableService = inject(CableService);
  private readonly deviceService = inject(DeviceService);
  private readonly dialogRef = inject(MatDialogRef<CableFormDialogComponent, boolean>);
