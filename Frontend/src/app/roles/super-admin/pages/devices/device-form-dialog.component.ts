...
import { DEVICE_STATUSES, DEVICE_TYPES, Device, DeviceStatus, DeviceType } from './device.model';
...
export class DeviceFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<DeviceFormDialogComponent, boolean>);
