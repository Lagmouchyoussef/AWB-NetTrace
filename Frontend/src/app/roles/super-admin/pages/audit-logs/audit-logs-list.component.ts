...
import { AuditLogFormDialogComponent } from './audit-log-form-dialog.component';
...
export class AuditLogsListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(AuditLogFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: AuditLog): void {
    this.dialog.open(AuditLogDetailDialogComponent, { width: '480px', data: row });
  }
