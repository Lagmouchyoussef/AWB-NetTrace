...
import {
  ...
  OverlayType,
} from './overlay-network.model';

@Component({
  selector: 'app-overlay-network-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class OverlayNetworkFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<OverlayNetworkFormDialogComponent, boolean>);
