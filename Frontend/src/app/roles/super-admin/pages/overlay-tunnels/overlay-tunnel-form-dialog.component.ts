...
import {
  ...
  OverlayTunnelStatus,
  OverlayTunnelType,
} from './overlay-tunnel.model';

@Component({
  selector: 'app-overlay-tunnel-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class OverlayTunnelFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<OverlayTunnelFormDialogComponent, boolean>);
