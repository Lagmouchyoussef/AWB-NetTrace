...
import { TelemetryConnectorFormDialogComponent } from './telemetry-connector-form-dialog.component';
import { TelemetryConnectorDetailDialogComponent } from './telemetry-connector-detail-dialog.component';

@Component({
  selector: 'app-telemetry-connectors-list',
  standalone: true,
...
export class TelemetryConnectorsListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(TelemetryConnectorFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: TelemetryConnector): void {
    this.dialog.open(TelemetryConnectorDetailDialogComponent, { width: '480px', data: row });
  }
