...
import { PATH_TRACE_STATUSES, PathTrace, PathTraceStatus } from './path-trace.model';

@Component({
  selector: 'app-path-trace-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class PathTraceFormDialogComponent implements OnInit {
  private readonly pathTraceService = inject(PathTraceService);
  private readonly deviceService = inject(DeviceService);
  private readonly dialogRef = inject(MatDialogRef<PathTraceFormDialogComponent, boolean>);
