...
export class EquipmentTypeFormDialogComponent {
  private readonly equipmentTypeService = inject(EquipmentTypeService);
  private readonly dialogRef = inject(MatDialogRef<EquipmentTypeFormDialogComponent, boolean>);
  ...
  protected readonly form = new FormGroup({
    ...
    category: new FormControl<EquipmentCategory>(this.data?.category ?? 'SERVER', {
      nonNullable: true,
      validators: [Validators.required],
    }),
