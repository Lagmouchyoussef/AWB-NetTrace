...
import { RealTimeDashboardFormDialogComponent } from './real-time-dashboard-form-dialog.component';
import { RealTimeDashboardDetailDialogComponent } from './real-time-dashboard-detail-dialog.component';

@Component({
  selector: 'app-real-time-dashboards-list',
  standalone: true,
...
export class RealTimeDashboardsListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(RealTimeDashboardFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: RealTimeDashboard): void {
    this.dialog.open(RealTimeDashboardDetailDialogComponent, { width: '480px', data: row });
  }
