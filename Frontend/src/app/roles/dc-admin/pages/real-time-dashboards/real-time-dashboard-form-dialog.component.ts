...
} from '../../../super-admin/pages/real-time-dashboards/real-time-dashboard.model';

@Component({
  selector: 'app-dc-admin-real-time-dashboard-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminRealTimeDashboardFormDialogComponent {
  private readonly realTimeDashboardService = inject(DcAdminRealTimeDashboardService);
  private readonly dialogRef = inject(
    MatDialogRef<DcAdminRealTimeDashboardFormDialogComponent, boolean>,
  );
