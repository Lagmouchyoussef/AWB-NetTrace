...
import { DcAdminInterventionFormDialogComponent } from './intervention-form-dialog.component';
import { DcAdminInterventionDetailDialogComponent } from './intervention-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-interventions-list',
  standalone: true,
...
export class DcAdminInterventionsListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminInterventionFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: Intervention): void {
    this.dialog.open(DcAdminInterventionDetailDialogComponent, { width: '480px', data: row });
  }
