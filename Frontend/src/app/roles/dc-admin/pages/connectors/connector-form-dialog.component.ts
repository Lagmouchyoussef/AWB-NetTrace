...
@Component({
  selector: 'app-dc-admin-connector-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminConnectorFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<DcAdminConnectorFormDialogComponent, boolean>);
