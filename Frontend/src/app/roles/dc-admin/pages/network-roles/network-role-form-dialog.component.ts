...
import {
  ...
  NetworkRoleStatus,
  NetworkRoleType,
} from '../../../super-admin/pages/network-roles/network-role.model';

@Component({
  selector: 'app-dc-admin-network-role-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminNetworkRoleFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<DcAdminNetworkRoleFormDialogComponent, boolean>);
