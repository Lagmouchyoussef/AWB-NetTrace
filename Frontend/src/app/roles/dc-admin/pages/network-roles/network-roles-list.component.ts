...
import { DcAdminNetworkRoleService } from '../../../../core/services/dc-admin-network-role.service';
import { downloadCsv } from '../../../../core/utils/csv-export';
import { NetworkRole } from '../../../super-admin/pages/network-roles/network-role.model';
import { DcAdminNetworkRoleFormDialogComponent } from './network-role-form-dialog.component';
import { DcAdminNetworkRoleDetailDialogComponent } from './network-role-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-network-roles-list',
  standalone: true,
...
export class DcAdminNetworkRolesListComponent implements OnInit {
  private readonly networkRoleService = inject(DcAdminNetworkRoleService);
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminNetworkRoleFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: NetworkRole): void {
    this.dialog.open(DcAdminNetworkRoleDetailDialogComponent, { width: '480px', data: row });
  }
