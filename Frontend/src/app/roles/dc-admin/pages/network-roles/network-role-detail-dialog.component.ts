...
@Component({
  selector: 'app-dc-admin-network-role-detail-dialog',
  standalone: true,
  imports: [MatDialogModule, TranslatePipe],
  templateUrl: './network-role-detail-dialog.component.html',
  styleUrl: './network-role-detail-dialog.component.css',
})
export class DcAdminNetworkRoleDetailDialogComponent {
  protected readonly data = inject<NetworkRole>(MAT_DIALOG_DATA);
  private readonly dialogRef = inject(MatDialogRef<DcAdminNetworkRoleDetailDialogComponent>);
