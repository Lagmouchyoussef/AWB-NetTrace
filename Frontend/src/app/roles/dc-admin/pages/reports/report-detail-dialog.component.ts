...
@Component({
  selector: 'app-dc-admin-report-detail-dialog',
  standalone: true,
...
export class DcAdminReportDetailDialogComponent {
  protected readonly data = inject<Report>(MAT_DIALOG_DATA);
  private readonly dialogRef = inject(MatDialogRef<DcAdminReportDetailDialogComponent>);
