...
import {
  ...
  ReportStatus,
  ReportType,
} from '../../../super-admin/pages/reports/report.model';
...
@Component({
  selector: 'app-dc-admin-report-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminReportFormDialogComponent {
  private readonly reportService = inject(DcAdminReportService);
  private readonly dialogRef = inject(MatDialogRef<DcAdminReportFormDialogComponent, boolean>);
