...
import {
  ...
  TelemetryProtocol,
} from '../../../super-admin/pages/telemetry-connectors/telemetry-connector.model';

@Component({
  selector: 'app-dc-admin-telemetry-connector-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminTelemetryConnectorFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(
    MatDialogRef<DcAdminTelemetryConnectorFormDialogComponent, boolean>,
  );
