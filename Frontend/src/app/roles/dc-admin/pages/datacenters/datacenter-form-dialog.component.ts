...
import {
  ...
  DatacenterStatus,
  DatacenterTier,
} from '../../../super-admin/pages/datacenters/datacenter.model';

@Component({
  selector: 'app-dc-admin-datacenter-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminDatacenterFormDialogComponent {
  private readonly datacenterService = inject(DcAdminDatacenterService);
  private readonly dialogRef = inject(MatDialogRef<DcAdminDatacenterFormDialogComponent, boolean>);
