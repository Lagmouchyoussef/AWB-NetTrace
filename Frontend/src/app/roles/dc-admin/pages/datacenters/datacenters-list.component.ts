...
import { DcAdminDatacenterFormDialogComponent } from './datacenter-form-dialog.component';
import { DcAdminDatacenterDetailDialogComponent } from './datacenter-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-datacenters-list',
  standalone: true,
...
export class DcAdminDatacentersListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminDatacenterFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: Datacenter): void {
    this.dialog.open(DcAdminDatacenterDetailDialogComponent, { width: '480px', data: row });
  }
