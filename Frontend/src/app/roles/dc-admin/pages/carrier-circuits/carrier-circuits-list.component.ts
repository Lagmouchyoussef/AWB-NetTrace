...
import { DcAdminCarrierCircuitFormDialogComponent } from './carrier-circuit-form-dialog.component';
import { DcAdminCarrierCircuitDetailDialogComponent } from './carrier-circuit-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-carrier-circuits-list',
  standalone: true,
...
export class DcAdminCarrierCircuitsListComponent implements OnInit {
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminCarrierCircuitFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: CarrierCircuit): void {
    this.dialog.open(DcAdminCarrierCircuitDetailDialogComponent, { width: '480px', data: row });
  }
