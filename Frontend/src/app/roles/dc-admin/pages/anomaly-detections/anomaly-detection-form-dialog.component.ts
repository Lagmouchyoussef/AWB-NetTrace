...
import {
  ...
  AnomalySeverity,
  AnomalyType,
} from '../../../super-admin/pages/anomaly-detections/anomaly-detection.model';
...
@Component({
  selector: 'app-dc-admin-anomaly-detection-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminAnomalyDetectionFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(
    MatDialogRef<DcAdminAnomalyDetectionFormDialogComponent, boolean>,
  );
