...
import { DcAdminAnomalyDetectionService } from '../../../../core/services/dc-admin-anomaly-detection.service';
import { downloadCsv } from '../../../../core/utils/csv-export';
import { AnomalyDetection } from '../../../super-admin/pages/anomaly-detections/anomaly-detection.model';
import { DcAdminAnomalyDetectionFormDialogComponent } from './anomaly-detection-form-dialog.component';
import { DcAdminAnomalyDetectionDetailDialogComponent } from './anomaly-detection-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-anomaly-detections-list',
  standalone: true,
...
export class DcAdminAnomalyDetectionsListComponent implements OnInit {
  private readonly anomalyDetectionService = inject(DcAdminAnomalyDetectionService);
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminAnomalyDetectionFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: AnomalyDetection): void {
    this.dialog.open(DcAdminAnomalyDetectionDetailDialogComponent, { width: '480px', data: row });
  }
