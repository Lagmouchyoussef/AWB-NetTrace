...
import {
  ...
  AuditAction,
  AuditLog,
} from '../../../super-admin/pages/audit-logs/audit-log.model';
...
@Component({
  selector: 'app-dc-admin-audit-log-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminAuditLogFormDialogComponent {
  private readonly auditLogService = inject(DcAdminAuditLogService);
  private readonly dialogRef = inject(MatDialogRef<DcAdminAuditLogFormDialogComponent, boolean>);
