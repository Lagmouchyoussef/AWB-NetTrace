...
import {
  ...
  TopologyLinkStatus,
  TopologyLinkType,
} from '../../../super-admin/pages/topology-links/topology-link.model';

@Component({
  selector: 'app-dc-admin-topology-link-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminTopologyLinkFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(
    MatDialogRef<DcAdminTopologyLinkFormDialogComponent, boolean>,
  );
