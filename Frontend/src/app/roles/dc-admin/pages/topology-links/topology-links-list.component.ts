...
import { DcAdminTopologyLinkService } from '../../../../core/services/dc-admin-topology-link.service';
import { downloadCsv } from '../../../../core/utils/csv-export';
import { TopologyLink } from '../../../super-admin/pages/topology-links/topology-link.model';
import { DcAdminTopologyLinkFormDialogComponent } from './topology-link-form-dialog.component';
import { DcAdminTopologyLinkDetailDialogComponent } from './topology-link-detail-dialog.component';

@Component({
  selector: 'app-dc-admin-topology-links-list',
  standalone: true,
...
export class DcAdminTopologyLinksListComponent implements OnInit {
  private readonly topologyLinkService = inject(DcAdminTopologyLinkService);
  ...
  protected onCreate(): void {
    const ref = this.dialog.open(DcAdminTopologyLinkFormDialogComponent, {
      width: '560px',
      data: null,
    });
  ...
  protected onView(row: TopologyLink): void {
    this.dialog.open(DcAdminTopologyLinkDetailDialogComponent, { width: '480px', data: row });
  }
