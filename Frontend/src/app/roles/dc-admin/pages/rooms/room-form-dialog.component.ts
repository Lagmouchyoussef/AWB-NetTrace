...
import {
  ...
  RoomStatus,
  RoomType,
} from '../../../super-admin/pages/rooms/room.model';

@Component({
  selector: 'app-dc-admin-room-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class DcAdminRoomFormDialogComponent implements OnInit {
  private readonly roomService = inject(DcAdminRoomService);
  private readonly datacenterService = inject(DcAdminDatacenterService);
  private readonly dialogRef = inject(MatDialogRef<DcAdminRoomFormDialogComponent, boolean>);
