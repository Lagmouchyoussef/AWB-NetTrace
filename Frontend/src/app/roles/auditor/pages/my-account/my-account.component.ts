...
import { AuditorMyAccountService } from '../../../../core/services/auditor-my-account.service';
...
// AuditorMyAccountController) and minus its own logout button (already in the topbar, always
// visible in this role's desktop layout).
@Component({
  selector: 'app-auditor-my-account',
  standalone: true,
  imports: [ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatIconModule, TranslatePipe],
  templateUrl: './my-account.component.html',
  styleUrl: './my-account.component.css',
})
export class AuditorMyAccountComponent implements OnInit {
  private readonly myAccountService = inject(AuditorMyAccountService);
