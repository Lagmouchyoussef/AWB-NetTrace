...
@Component({
  selector: 'app-ne-overlay-tunnel-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeOverlayTunnelFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<NeOverlayTunnelFormDialogComponent, boolean>);
