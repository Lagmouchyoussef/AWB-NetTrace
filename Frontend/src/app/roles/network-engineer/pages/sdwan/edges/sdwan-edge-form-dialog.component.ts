...
@Component({
  selector: 'app-ne-sdwan-edge-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeSdwanEdgeFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<NeSdwanEdgeFormDialogComponent, boolean>);
