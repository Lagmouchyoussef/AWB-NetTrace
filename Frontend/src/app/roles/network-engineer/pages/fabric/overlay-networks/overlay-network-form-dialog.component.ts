...
@Component({
  selector: 'app-ne-overlay-network-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeOverlayNetworkFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<NeOverlayNetworkFormDialogComponent, boolean>);
