...
@Component({
  selector: 'app-ne-network-role-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeNetworkRoleFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(MatDialogRef<NeNetworkRoleFormDialogComponent, boolean>);
