...
import { NetworkEngineerMyAccountService } from '../../../../core/services/network-engineer-my-account.service';
...
// NetworkEngineerMyAccountController) and minus its own logout button (already in the topbar,
// always visible in this role's desktop layout).
@Component({
  selector: 'app-network-engineer-my-account',
  standalone: true,
  imports: [ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatIconModule, TranslatePipe],
  templateUrl: './my-account.component.html',
  styleUrl: './my-account.component.css',
})
export class NetworkEngineerMyAccountComponent implements OnInit {
  private readonly myAccountService = inject(NetworkEngineerMyAccountService);
