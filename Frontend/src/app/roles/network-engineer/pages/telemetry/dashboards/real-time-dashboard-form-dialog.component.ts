...
@Component({
  selector: 'app-ne-real-time-dashboard-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeRealTimeDashboardFormDialogComponent {
  private readonly realTimeDashboardService = inject(NetworkEngineerRealTimeDashboardService);
  private readonly dialogRef = inject(
    MatDialogRef<NeRealTimeDashboardFormDialogComponent, boolean>,
  );
