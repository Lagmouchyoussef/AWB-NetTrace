...
@Component({
  selector: 'app-ne-telemetry-connector-form-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class NeTelemetryConnectorFormDialogComponent implements OnInit {
  ...
  private readonly dialogRef = inject(
    MatDialogRef<NeTelemetryConnectorFormDialogComponent, boolean>,
  );
